...
var NgValidations = (function () {
    ...
    NgValidations.prototype.handleConditionalValidations = function (control, form) {
        ...
        changes.subscribe(function (value) {
            conditions.forEach(function (condition, index) {
                ...
                if (conditions.findIndex(function (c) {
                ...
                if (currentControl.value.length || _this.checkIfRequired(controlRequired, staticRequired).length) {
    ...
    NgValidations.prototype.useDefaultConfig = function () {
        ...
        this.setValidatorDefinitions(sample_validation_definitions_1.validationDefinitions);
    };
